...
void Engine::Lesson03_Animation::Init()
{
	...
	sprite->SetNumXFrames(14)->SetNumYFrames(4)->AddAnimation("hit", 2, 4)->AddAnimation("spikes", 5, 12)->AddAnimation("idle-1", 14, 27)->AddAnimation("idle-2", 28, 41)->AddAnimation("spikes-out", 42, 49)->SetScale(10)->SetAnimationDuration(30)->SetPosition(300, 0)->PlayAnim("idle-2");
